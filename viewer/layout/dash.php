...
<head>
    ...
    <link rel="stylesheet" href="viewer/layout/assets/css/style.css"/>
...
<div class="dash">
    <aside class="dash_sidebar">
        <article class="dash_sidebar_user">
            <div><img class="dash_sidebar_user_thumb" src="viewer/layout/assets/images/avatar.jpg" alt="" title=""/></div>
            <h3 class="dash_sidebar_user_name"><a href="dash.php?app=users/edit&id=1">Fernando</a></h3>
        </article>
...
<script src="viewer/layout/assets/js/jquery-ui.js"></script>
